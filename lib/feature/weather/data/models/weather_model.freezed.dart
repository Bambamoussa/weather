...
/// @nodoc
abstract class _$$_WeathersModelsCopyWith<$Res>
    implements $WeathersModelsCopyWith<$Res> {
  factory _$$_WeathersModelsCopyWith(
          _$_WeathersModels value, $Res Function(_$_WeathersModels) then) =
      __$$_WeathersModelsCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'name') String name,
...
/// @nodoc
class __$$_WeathersModelsCopyWithImpl<$Res>
    extends _$WeathersModelsCopyWithImpl<$Res, _$_WeathersModels>
    implements _$$_WeathersModelsCopyWith<$Res> {
  __$$_WeathersModelsCopyWithImpl(
      _$_WeathersModels _value, $Res Function(_$_WeathersModels) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_WeathersModels(
      name: null == name
          ? _value.name
          : name // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_WeathersModels implements _WeathersModels {
  const _$_WeathersModels(
      {@JsonKey(name: 'name') required this.name,
      @JsonKey(name: 'main') required this.mainWeathersModels});

  factory _$_WeathersModels.fromJson(Map<String, dynamic> json) =>
      _$$_WeathersModelsFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_WeathersModelsCopyWith<_$_WeathersModels> get copyWith =>
      __$$_WeathersModelsCopyWithImpl<_$_WeathersModels>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_WeathersModelsToJson(
      this,
    );
  }
}
